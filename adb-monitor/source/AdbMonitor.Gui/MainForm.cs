...
internal sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        _monitorRoot = MonitorPaths.FindMonitorRoot(_installDir);
        _configPath = Path.Combine(_monitorRoot, "monitor.config");
        _runnerScriptPath = Path.Combine(_monitorRoot, "core", "runner.ps1");
    ...
    private string ConfigDir => Path.GetDirectoryName(_configPath) ?? _monitorRoot;
